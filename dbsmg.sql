...
INSERT INTO `tbl_login` VALUES (1,'jose','123',1);
...
CREATE TABLE `tbl_pasaport_ciudadano` (
  ...
  CONSTRAINT `fk_tbl_ciudadanos_mayores_tbl_pasaporte1` FOREIGN KEY (`cui`) REFERENCES `tbl_ciudadanos_mayores` (`CUI`),
  CONSTRAINT `fk_tbl_ciudadanos_menores_tbl_pasaporte1` FOREIGN KEY (`cui`) REFERENCES `tbl_ciudadanos_menores` (`CUI`),
...
-- Dump completed on 2020-02-17  9:40:32
